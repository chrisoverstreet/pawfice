...
export default function PetsTab(props: { pets: PageData['pets'] }) {
  const pets = props.pets.reduce<NonNullable<PageData['pets'][0]['profile']>[]>(
    (acc, p) => {
      if (p.profile) {
        acc.push(p.profile);
      }
                ...
                <div className='aspect-video relative overflow-hidden'>
                  {pet.avatar_url ? (
                    ...
                    <div
                      ...
                      style={{ background: getGradient(pet.short_id) }}
                    >
